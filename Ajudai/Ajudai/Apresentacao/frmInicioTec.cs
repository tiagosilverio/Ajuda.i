...
namespace Ajudai.Apresentacao
{
    public partial class frmInicioTec : Form
    {
        ...
        {
            InitializeComponent();
            ExibirChamadosAbertosTec();
            ExibirChamadosAndamentoTec();
            ExibirChamadosConcluidosTec();
            ExibirNome();
        }
        ...
        private void btnAtulizarAndamento_Click(object sender, EventArgs e)
        {
            ExibirChamadosAndamentoTec();
        }
        ...
        private void ExibirChamadosAbertosTec()
        {
            Modelo.Controle controle = new Modelo.Controle();
            dgvChamadosAbertos.DataSource = controle.ListarChamadosAbertosTec();            
        ...
        private void ExibirChamadosAndamentoTec()
        {
            Modelo.Controle controle = new Modelo.Controle();
            dgvChamadosAndamento.DataSource = controle.ListarChamadosAndamentoTec();
        ...
        private void ExibirChamadosConcluidosTec()
        {
            Modelo.Controle controle = new Modelo.Controle();
            dgvChamadosConcluidos.DataSource = controle.ListarChamadosConcluidosTec();
        ...
        private void dgvChamadosAbertos_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            detalhes.nudPrioridade.Enabled = false;            
            detalhes.cmbFuncionarios.Enabled = false;
            detalhes.cmbFuncionarios.Text = Modelo.SessaoSistema.NomeExibicao;
            detalhes.ShowDialog();
        }
